...
<div class="flex flex-col h-full bg-white/30 backdrop-blur-sm rounded-2xl border border-bear-light/50 shadow-lg overflow-hidden">
	<!-- Chat messages -->
		...
		{#if $messages.length === 0}
			<div class="flex flex-col items-center justify-center h-full text-center px-4">
				...
				<p class="font-comfortaa text-bear-dark/60 text-sm">
					...
					<span class="text-xs text-bear-brown/40">You can also pat the bear's head or give it a hug</span>
				</p>
			</div>
		{:else}
		...
		{#if $isLoading}
			<div class="flex justify-start mb-3">
				<div class="flex items-end gap-2">
					...
					<div class="bg-white/80 backdrop-blur-sm rounded-2xl rounded-bl-md shadow-sm border border-bear-light/50">
						<BouncingDots />
					</div>
				</div>
			</div>
